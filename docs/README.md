...
## Start here
- **[STORY.md](STORY.md)** gives SentAInce in human terms: the anatomy (immune system, muscle memory, sleep…),
  the honest numbers, and what the dashboard shows. The gentlest on-ramp.
- **[GLOSSARY.md](GLOSSARY.md)** is the biology↔CS↔code Rosetta with status tags. Read this first for the terms.
- **[CLAIMS.md](CLAIMS.md)** is the evidence ledger: what is PROVEN / LIVE / DORMANT / MARGINAL. **The source
  of truth every other doc is held to**, because this project's identity is honest non-overclaiming.
- **[../README.md](../README.md)** is the repo overview and quickstart.
...
| **In a chat app** (Claude Desktop, ChatGPT, Cline, any MCP client) | [MCP_SERVER.md](MCP_SERVER.md) → [CHATGPT_APP.md](CHATGPT_APP.md). **Memory only, not the reflex** |
...
| Document | What it is |
|---|---|
| [STORY.md](STORY.md) | SentAInce in human terms: the anatomy, the honest numbers, the two dashboard views |
...
- **Evidence and gauge runs**: [`../results/`](../results/), such as `attribution_layer2/` and `bridge_gauge_v1/`.
